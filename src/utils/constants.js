...
export const ASTEROID_ROTATION_SPEED_RANGE = 0.1; // max total rotation speed variation
export const ASTEROID_BASE_POINTS = 8;
export const ASTEROID_POINT_VARIATION = 4; // adds 0-3 points
export const ASTEROID_RADIUS_VARIATION_BASE = 0.7;
export const ASTEROID_RADIUS_VARIATION_RANGE = 0.6; // results in 0.7-1.3
